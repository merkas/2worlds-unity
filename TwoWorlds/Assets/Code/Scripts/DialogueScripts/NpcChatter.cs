...
public class NpcChatter : MonoBehaviour //needs own tag for player as trigger
{
    ...
    void ShowComment()
    {
        ...
        {
            bubble = Instantiate(speechBubble, canvas2.transform);
            bubble.transform.localScale -= new Vector3(chatterText2.transform.localScale.x * .5f, chatterText2.transform.localScale.y * .5f, 0);
